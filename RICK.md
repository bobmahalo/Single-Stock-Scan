# ANTIGRAVITY PIPELINE: SINGLE STOCK ENGINE V2 | TARGET: RICK
> Report Generated: 2026-08-24 04:56:56 HST

## PRONG 1: THE COMPANY (Critical Fundamentals)

- **Price:** $30.92
- **Market Cap:** $236,584,384
- **Next Earnings:** 2026-08-06
- **Directly Registered:** 75 Shareholders *(High Conviction Base)*
...
| PEG Ratio | None |
| P/TBV | 21.78 |
| Shareholder Yield | 7.77% (Div: 1.0% \| Buybacks: 4.6%) |
| Altman Z-Score | **1.08** *(>3.0 is Safe)* |
| Current Ratio | 0.56 |
| Piotroski F-Score | 6 / 9 |
| ROIC (Annualized) | 8.27% |
| FCF Yield | 16.49% |

### SEC Financial Trajectory
- **Verdict:** ELIMINATE *(Score: 0)*
- **FCF Grade:** D - Mild decline -12%
- **Net Income Grade:** F - Severe decline -125%
- **Revenue Grade:** B - Moderate growth +18%, 100% quarters improving

### Management & Board (Skin in the Game)
- **Insider Score:** 100/100
- **Net Insider Trade:** $74,437
...
- **Whale Alerts:** 16 Active 13D/A Filings Found!

### Off-Exchange & Short Interest
- **Avg Dark Short Vol:** 12,402 shares/day
- **Avg Dark Short %:** 45.9% of Off-Exchange Volume
...
Debug: Client initialized with Key: 2Hy2...
---
### CASH-SECURED PUTS (14-45 DTE) FOR RICK
---
...
Debug: Client initialized with Key: 2Hy2...
---
### THE BULL RISK REVERSAL FOR RICK
---
...
[!] Could not locate Gamma Walls for RICK.
Debug: Client initialized with Key: 2Hy2...
---
### JADE LIZARD SETUP (30-45 DTE) FOR RICK
---
...
[!] No valid LEAPS (>300 DTE) found for RICK.
Debug: Client initialized with Key: 2Hy2...
---
### VOLATILITY ARBITRAGE & SPECULATIVE PLAYS FOR RICK
---
...
[ VOLATILITY METRICS ]
Historical Volatility (30-Day) : 34.81%
Implied Volatility (ATM)       : 49.44%
Premium Ratio (IV/HV)          : 1.42

  [ VOLATILITY EDGE: SHORT IRON BUTTERFLY ]
*Options are EXPENSIVE. Selling bloated premium with defined risk.*
Target Expiration: 2026-09-18 (25-DTE)
Expected Move (EM): ±$4.00
SELL 1x $30.00 Call (Credit: $1.75)
SELL 1x $30.00 Put  (Credit: $1.45)
BUY  1x $37.50 Call (Debit : $0.35)  <-- 4x EM Wing
BUY  1x $15.00 Put  (Debit : $0.20)  <-- 4x EM Wing
Total Net Credit : $2.65
Max Risk (Margin): $485.00
