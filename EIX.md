# ANTIGRAVITY PIPELINE: SINGLE STOCK ENGINE V3 | TARGET: EIX
> Report Generated: 2026-08-31 08:18:32 HST
...
| PEG Ratio | 5.01 |
| P/TBV | 1.18 |
| Shareholder Yield | 17.47% (Div: 5.0% \| Buybacks: 0.3%) |
| Altman Z-Score | **0.36** *(>3.0 is Safe)* |
| Current Ratio | 0.66 |
| Piotroski F-Score | 7 / 9 |
| ROIC (Annualized) | 6.50% |
| FCF Yield | -11.12% |

### SEC Financial Trajectory
- **Verdict:** ELIMINATE *(Score: 0)*
- **FCF Grade:** F - Final quarter negative (-112,000,000)
- **Net Income Grade:** B - Good growth +140%, mixed consistency
- **Revenue Grade:** C - Flat trend -1%

### SEC Fraud Forensics
- **Overall Verdict:** ✅ CLEAN
- **Bad Debt (AR vs Allowance):** ✅ PASS - AR YoY: -17.1% | Allowance YoY: +10.8%
- **Revenue Acceleration (DSO):** ✅ PASS - DSO YoY Change: -21.4%
- **Operating Expense Cap (WorldCom):** ✅ PASS - Insufficient OpEx/CapEx data.

### Management & Board (Skin in the Game)
- **Insider Score:** 0/100
- **Net Insider Trade:** $-820,458
...
- **Avg Dark Short Vol:** 999,081 shares/day
- **Avg Dark Short %:** 63.5% of Off-Exchange Volume
...
Current Price of EIX: $53.75
Days to Earnings  : 57 Days (Date: 2026-10-27)
Near-Term ATM IV  : 📈 51% `[████░░░░]`

[!] No options found for TACTICAL RADAR (0-5 DTE)
...
---
### THE WHEEL: CASH-SECURED PUTS (14-45 DTE) FOR EIX
---
...
If it drops, you buy the stock on sale. If it doesn't drop, you keep the cash.*
  ...
  [!] No suitable Safe CSP found.
---
---
### THE WHEEL: COVERED CALLS (14-45 DTE) FOR EIX
---
...
*Priced outside the 1 Standard Deviation Expected Move (+/- $6.11)*
SELL 1x 2026-09-18 (18-DTE) $65.00 Call
Premium Collected: $0.25
Annualized Yield : 9.4%
Max Total Return : 21.2% (If called away at $65.00)
---
